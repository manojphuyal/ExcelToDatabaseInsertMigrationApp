        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactCompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ContactLabelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StreetName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    PoBox = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    StateProvince = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    PostalCodeZip = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyAbbrevation = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    ParentCompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ContactSourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DefaultThrough = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    ScopeOfWork = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    MailAddress = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    CompanyCEO = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    IsQuickEntry = table.Column<bool>(type: "bit", maxLength: 400, nullable: false),
                    TagNames = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ContactLabelDatas",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OldId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LabelData = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    ContactLabelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ContactPersonId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ContactCompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactLabelDatas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ContactLabelGroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OldId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OldCityId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OldCountryId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Suffix = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    FirstName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    MiddleName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    NickName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    PersonalAbbrevation = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AnniversaryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SpouseName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    DesignationName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    DepartmentName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    Hobbies = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    ...
                    ConatactSourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DefaultThrough = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    IsQuickEntry = table.Column<bool>(type: "bit", maxLength: 400, nullable: false),
                    TagNames = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Class = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    Roll = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalFeatures = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReferenceOthers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryInchargeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProjectTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Budget = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BudgetCurrencyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Department = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OfficialInvitation = table.Column<bool>(type: "bit", nullable: false),
                    DocumentCostCurrencyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DocumentCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    BankGuranteeValueCurrencyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    BankGuranteeValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PublicationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SubmissionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OpeningDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BidValidity = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BankGuranteeValidity = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenderBasics", x => x.Id);
                });
